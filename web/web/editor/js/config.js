...
rteImagePath = "editor/images/";
// Path to insert form popup.
rteHTMLPathInsertForm = "editor/html/insert_form.html";
// Path to insert checkbox popup.
rteHTMLPathInsertCheckbox = "editor/html/insert_checkbox.html";
// Path to insert radio button popup.
rteHTMLPathInsertRadiobutton = "editor/html/insert_radiobutton.html";
// Path to insert text area popup.
rteHTMLPathInsertTextArea = "editor/html/insert_textarea.html";
// Path to insert submit button popup.
rteHTMLPathInsertSubmit = "editor/html/insert_submit.html";
// Path to insert image submit button popup.
rteHTMLPathInsertImageSubmit = "editor/html/insert_image_submit.html";
// Path to reset form button popup.
rteHTMLPathInsertReset = "editor/html/insert_reset.html";
// Path to insert hidden form field popup.
rteHTMLPathInsertHidden = "editor/html/insert_hidden.html";
// Path to insert password field popup.
rteHTMLPathInsertPassword = "editor/html/insert_password.html";
// Path to insert text field popup.
rteHTMLPathInsertText = "editor/html/insert_text.html";
// Path to insert table popup.
rteHTMLPathInsertTable = "editor/html/insert_table.html";
// Path to edit table properties popup.
rteHTMLPathEditTable = "editor/html/edit_table.html";
// Path to insert link popup.
rteHTMLPathInsertLink = "editor/html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = "editor/html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = "editor/html/insert_image.html";
